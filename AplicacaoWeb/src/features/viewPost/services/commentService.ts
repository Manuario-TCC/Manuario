export const commentService = {
    ...
    disableComment: async (id: string, reason: string) => {
        const response = await fetch(`/api/comments/${id}/disable`, {
            method: 'PATCH',
            headers: {
        ...
        if (!response.ok) {
            ...
            throw new Error(errorData.error || 'Falha ao desativar o comentário');
        }
