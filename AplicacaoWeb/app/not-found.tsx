...
export default function NotFound() {
    return (
        <main className="relative min-h-screen flex flex-col items-center justify-center bg-[hsl(240_10%_4%)] text-white overflow-hidden">
            <div className="absolute left-1/2 top-1/2 h-[31rem] w-[31rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/50 opacity-10 blur-[120px]" />

            <div className="relative z-10 flex flex-col items-center">
                <div className="relative h-56 w-72 mb-10 flex items-center justify-center">
                    <div className="absolute w-64 h-40 bg-primary/50  opacity-30 blur-[60px] rounded-full z-0 animate-pulse" />

                    <div className="absolute -translate-x-20 animate-float-1 z-10">
                        <div className="h-40 w-28 bg-card border border-primary rounded-xl -rotate-12 shadow-[0_0_25px_var(--color-primary)] flex flex-col items-center justify-between p-3">
                    ...
                    <div className="absolute h-48 w-32 z-20 [perspective:1000px]">
                        <div className="relative w-full h-full animate-card-flip-continuous [transform-style:preserve-3d]">
                            <div className="absolute inset-0 bg-card border-2 border-primary rounded-xl shadow-[0_0_40px_color-mix(in_srgb,var(--color-primary)_50%,transparent)] flex flex-col items-center justify-between p-3 [backface-visibility:hidden]">
                            ...
                            <div className="absolute inset-0 bg-card border-2 border-primary rounded-xl shadow-[0_0_40px_color-mix(in_srgb,var(--color-primary)_50%,transparent)] flex flex-col items-center justify-center p-3 [backface-visibility:hidden] [transform:rotateY(180deg)]">
                ...
                <div className="text-center space-y-4 px-6 z-30">
                    ...
                    <p className="text-sub-text text-base md:text-lg max-w-md mx-auto leading-relaxed mt-2">
                ...
                <div className="mt-10">
                    <Link
                        href="/feed"
                        className="inline-flex items-center justify-center bg-primary text-white px-8 py-4 text-base font-bold rounded-2xl shadow-[0_10px_30px_-10px_var(--color-primary)] transition-all hover:scale-105 active:scale-95 z-30 relative"
                    >
