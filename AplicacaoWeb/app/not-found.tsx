...
export default function NotFound() {
    return (
        <main className="relative min-h-screen flex flex-col items-center justify-center bg-[hsl(240_10%_4%)] text-white overflow-hidden">
            {/* Brilho geral de fundo */}
            <div className="absolute left-1/2 top-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[hsl(275_85%_55%)] opacity-10 blur-[120px]" />

            <div className="relative z-10 flex flex-col items-center">
                <div className="relative h-56 w-72 mb-10 flex items-center justify-center">
                    {/* Foco de luz pulsante direto atrás das cartas */}
                    <div className="absolute w-64 h-40 bg-[hsl(275_85%_55%)] opacity-30 blur-[60px] rounded-full z-0 animate-pulse" />

                    {/* Carta Esquerda (Mais afastada: -translate-x-20) */}
                    <div className="absolute -translate-x-20 animate-float-1 z-10">
                        <div className="h-40 w-28 bg-[hsl(270_60%_15%)] border border-[hsl(275_80%_60%/0.4)] rounded-xl -rotate-12 shadow-[0_0_25px_rgba(168,85,247,0.25)] flex flex-col items-center justify-between p-3">
                    ...
                    {/* Carta Direita (Mais afastada: translate-x-20) */}
                    ...
                    <div className="absolute h-48 w-32 z-20 [perspective:1000px]">
                        <div className="relative w-full h-full animate-card-flip-continuous [transform-style:preserve-3d]">
                            <div className="absolute inset-0 bg-[hsl(270_60%_15%)] border-2 border-[hsl(280_100%_70%)] rounded-xl shadow-[0_0_40px_rgba(168,85,247,0.5)] flex flex-col items-center justify-between p-3 [backface-visibility:hidden]">
                            ...
                            <div className="absolute inset-0 bg-[hsl(275_85%_45%)] border-2 border-[hsl(280_100%_70%)] rounded-xl shadow-[0_0_40px_rgba(168,85,247,0.5)] flex flex-col items-center justify-center p-3 [backface-visibility:hidden] [transform:rotateY(180deg)]">
                                <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-white mb-2 bg-white flex items-center justify-center">
                                    <Image
